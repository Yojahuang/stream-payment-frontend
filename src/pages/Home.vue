<template>
    <div class="w-75 mx-auto">
        <div class="text-center font-weight-medium text-h3 mb-4">Stream Payment</div>
        <div class="text-center font-weight-medium">Real-time payments made easy with Stream Payment and blockchain.
        </div>
