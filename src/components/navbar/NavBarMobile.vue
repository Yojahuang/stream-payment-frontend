<template>
    <div class="d-flex justify-space-between align-center">
        <div class="font-weight-bold ml-5 text-white">Stream Payment</div>
        <div class="d-flex align-center justify-begin">
            ...
            <v-btn class="mx-2" variant="text" v-else @click="openSettingDialog()" icon="mdi-account"></v-btn>
            <v-btn class="text-white" @click="toggleMenu()" icon="mdi-menu" variant="text"></v-btn>
        </div>
    </div>
    <div class="my-2" v-if="showMenu">
        <v-btn class="w-full mx-auto my-2 text-white" block variant="text">Dashboard</v-btn>
